...
function NavBarLower() {
    return (
        <div className="fixed bottom-0 h-16 w-screen m-0 flex flex-row items-center justify-around bg-Green text-white shadow-lg">
            <a href="/"><NavBarInfIcon icon={<FaHouse size="20" />} text='Home' /></a>
            <a href="/"><NavBarInfIcon icon={<MdMessage size="20" />} text='Messages' /></a>
            <a href="/"><NavBarInfNew icon={<FaPlus size="40" />} text='New' /></a>
            <a href="/"><NavBarInfIcon icon={<BsFillPeopleFill size="20" />} text='Friends' /></a>
            <a href="/"><NavBarInfIcon icon={<IoPerson size="20" />} text='Profile' /></a>
        </div>
    );
}
