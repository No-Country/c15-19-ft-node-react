...
function NavBarLower() {
  return (
    <div className="fixed bottom-0 h-[3rem] w-screen m-0 flex flex-row items-center justify-around bg-Green text-white shadow-lg">
      <a href="/home">
        <NavBarInfIcon icon={<FaHouse size="20" />} text="Home" />
      </a>
      <a href="/categories">
        <NavBarInfIcon icon={<MdMessage size="20" />} text="Categories" />
      </a>
      <a href="/">
        <NavBarInfNew icon={<FaPlus size="40" />} text="New" />
      </a>
      <a href="/">
        <NavBarInfIcon icon={<BsFillPeopleFill size="20" />} text="Friends" />
      </a>
      <a href="/profile">
