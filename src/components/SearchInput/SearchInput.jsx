...
const SearchInput = ({ onSearch, onFilterChange }) => {
    ...
    return (
        <article className="flex flex-row lg:justify-between items-center w-[85vw]">
            <form className="ml-[1rem] flex items-center justify-center bg-gray-50 h-[3rem] px-[1rem] border-2 rounded-full shadow-xl" onSubmit={handleSubmit}>
                <input
                ...
                <button className="" type="submit">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#6B7280" className="w-5 h-5">
                        <path fillRule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clipRule="evenodd" />
                    </svg>
                </button>
            </form>
            <form className="hidden lg:block" action="filtered">
                <label className='dark:text-white text-lg mx-3' htmlFor="filter">Filtrar Categorias</label>
                <select
                ...
                >
                    <option className="mx-4" value="all">Todas las Categorías</option>
